...
public class RumblingLoopSI extends AbstractTickableSoundInstance {
    private boolean fadeOut;
    private int fadeTicks;

    public RumblingLoopSI(SoundEvent soundEvent, float volume, float pitch, boolean loopable) {
