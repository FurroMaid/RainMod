...
public class LightRainLoopSI extends AbstractTickableSoundInstance {
    private boolean fadeOut;
    private int fadeTicks;

    public LightRainLoopSI(SoundEvent soundEvent, float volume, float pitch, boolean loopable) {
